  ...
  return (
    ...
    >
      <div className="container max-w-4xl mx-auto text-center z-10">
        ...
        <p className="text-lg md:text-xl mb-8 text-muted-foreground max-2-2xl mx-auto opacity-0 animate-fade-in-delay-3">I'm a SoCal based software developer. I've previously worked for a branding agency in a fullstack role and am looking for my next fulltime adventure. I enjoy working in both a large, collaborative environments, as well as just off to the side, in my own little playground. Peep my projects and learn more about me below. Thanks for stopping by!</p>
